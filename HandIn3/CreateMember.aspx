<%@ Page Title="" Language="C#" MasterPageFile="~/Coach.Master" AutoEventWireup="true" CodeBehind="CreateMember.aspx.cs" Inherits="HandIn3.CreateMember" Theme="ThemeMyFitness" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <p class="toptext" >Please enter information to create a new member</p>
        <table class="myTable">
            <tr>
