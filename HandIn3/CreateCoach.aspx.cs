...
namespace HandIn3
{
    public partial class CreateCoach : System.Web.UI.Page
    {
        ...
        protected void ButtonCreate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = null;
            string sqlins = "insert into coach values(@CoachNumber, @Name, @Phonenumber, @Email, @Gender, @Password)";
            ...
            try
            {
                ...
                cmd.Parameters["@CoachNumber"].Value = Convert.ToInt32(TextBoxCoach.Text);
